...
var wrap$1 = function (set) {
  return MSIE ? function (fn, time /* , ...args */) {
    return set(_invoke(_partial, [].slice.call(arguments, 2),
    // eslint-disable-next-line no-new-func
...
var QuickVis = function () {
    ...
    createClass(QuickVis, [{
        ...
        value: function _resizeObserve() {
            ...
            this.contentRect = {};
            this.observer = new index$2(function (entries, observer) {
...
var Sparkline = function (_QuickVis) {
    ...
    function Sparkline(data, config) {
        ...
        return possibleConstructorReturn(this, (Sparkline.__proto__ || Object.getPrototypeOf(Sparkline)).call(this, data, "div", template, "sparkline", config));
    }
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return get$1(Sparkline.prototype.__proto__ || Object.getPrototypeOf(Sparkline.prototype), "_render", this).call(this);
...
var StackedBar = function (_QuickVis) {
    ...
    function StackedBar(data, config) {
        ...
        return possibleConstructorReturn(this, (StackedBar.__proto__ || Object.getPrototypeOf(StackedBar)).call(this, data, "div", stackedBarTemplate, "stacked-bar", config));
    }
...
var Bar = function (_QuickVis) {
    inherits(Bar, _QuickVis);

    function Bar(data, config) {
        classCallCheck(this, Bar);
        return possibleConstructorReturn(this, (Bar.__proto__ || Object.getPrototypeOf(Bar)).call(this, data, "div", template$1, "simple-bar", config));
    }
...
var WinLoss = function (_QuickVis) {
    ...
    function WinLoss(data, config) {
        ...
        return possibleConstructorReturn(this, (WinLoss.__proto__ || Object.getPrototypeOf(WinLoss)).call(this, data, "div", winLossTemplate, "win-loss", config));
    }
    ...
    createClass(WinLoss, [{
        ...
        value: function focus(val) {
            if (this.data && this.rendered) {
                ...
                var topEls = Array.from(this.el.querySelectorAll(".topsies .winloss-block"));
                var bottomEls = Array.from(this.el.querySelectorAll(".bottomsies .winloss-block"));
                if (!topEls || !bottomEls) {
                ...
                if (end) {
                    ...
                    focusEls = [].concat(toConsumableArray(topEls.slice(startPos, pos)), toConsumableArray(bottomEls.slice(startPos, pos)));
                }
